...
cls
echo ============================
echo Welcome to BitView OS 4.0
echo ============================
...
if "%choice%"=="12" goto powerOptions
goto menu
...
echo ============================
echo To customize the font, follow these steps:
echo 1. Right-click on the title bar of this window. MAKE SURE ITS A SHORTCUT OTHERWISE IT WONT WORK
echo 2. Select 'Properties'.
echo 3. Go to the 'Font' tab.
echo 4. Choose your desired font and size.
echo 5. Click 'OK' to apply changes.
echo ============================
