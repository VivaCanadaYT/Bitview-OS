...
echo [12] Virtual Window
echo [13] Activate Bitview OS
echo [14] User Feedback
...
if "%choice%"=="12" goto virtualPc
if "%choice%"=="13" goto activateOs
if "%choice%"=="14" goto userFeedback
if "%choice%"=="15" goto powerOptions
goto menu
...
set "feedbackFile=feedback.txt"

> "%feedbackFile%" echo User Feedback Log
>> "%feedbackFile%" echo ==================
...
set /p "feedback=Please enter your feedback (type 'exit' to finish): "
...
echo !feedback! >> "%feedbackFile%"
echo Feedback recorded. Press any key to continue...
pause >nul
goto menu
...
echo Virtual Window
echo ================
echo This Section will going to open a new window of Bitview OS 4.5
echo You can Use this feature any time you want
echo just dont use too much!
echo ================================================================
echo Are you sure you want to use Virtual Window ? (Y/N)
set /p confirm=Choice:

if /i "%confirm%"=="Y" (
    cls
    echo Opening Virtual Window...
    timeout /t 2 >nul
    start /wait 4.5.bat
    exit
) else (
